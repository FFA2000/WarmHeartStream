...
Page({
  ...
  makeObj: function (content) {
    var obj = {
      url: "http://api.heclouds.com/devices/561746562/datapoints?type=3",
      ...
      method: "post",
      //const apo = app.globalData.dataflag,
      data: {
       /* 
       **数据流的一种形式，由于暂时未能实现变量转化为常量，所以没有使用
       "value": [
          {
            "id": "warmheart", 
            "datapoints": [
              {
                ...
                "value": content,  
                "userflag": app.globalData.dataflag,//上传数据点
              },
        ...
        'value':content,
        'userflag': app.globalData.dataflag,
      },
      success: function (res) {
        console.log(res)
      }
  ...
  saveDataToServer: function(event) {
    ...
    this.sendRequset(this.makeObj(this.data.content))
